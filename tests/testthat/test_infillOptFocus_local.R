...
if (Sys.info()[1] == "Linux"){
  load_all("/home/muddy/Tresors/Documentsacer/_UWyo/mlrMBO/R")
} else {
  load_all("C:/Users/peter/My Tresors/Documentsacer/_UWyo/mlrMBO/R")
}

# load local mlrMBO copy
if (Sys.info()[1] == "Linux"){
  setwd("/home/muddy/Tresors/Documentsacer/_UWyo/mlrMBO/R")
} else {
  setwd("C:/Users/peter/My Tresors/Documentsacer/_UWyo/mlrMBO/R")
}
